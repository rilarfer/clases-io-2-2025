...
\begin{parts}
    \part Plantea el modelo balanceado.
...
\begin{parts}
    \part Usa el método de asignación (algoritmo de Hungría).
    \part Muestra el proceso con dos iteraciones y encuentra la asignación óptima.
